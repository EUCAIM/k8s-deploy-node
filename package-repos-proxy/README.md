...
Pass `--index-url http://py-repo-service.package-repos-proxy:3141/root/pypi/+simple/` and `--trusted-host py-repo-service.package-repos-proxy` to pip.  
Example: 
```
pip  install --index-url http://py-repo-service.package-repos-proxy:3141/root/pypi/+simple/ --trusted-host py-repo-service.package-repos-proxy datetime
```
