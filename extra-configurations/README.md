...
- __Core services__: they are in charge of mantain a minimal functionality of the cluster. Examples: 
    ...
    - :construction: Traceability system (_Tracer Service_)
...
- __Core applications__: 
    - :construction: Data ingestion (_Quibim Precision_, _PACS_)
...
where :construction: represents that the service is running at the cluster and :heavy_check_mark: represents that it is running using the appropriate priorityClass.
